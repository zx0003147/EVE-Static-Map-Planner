...
- `feature-api`: Feature API compatibility family 2 contracts (current artifact `2.5.0`) and generic external Pack test fixture.
...
- Core owns Feature API runtime compatibility family 2, the current `2.5.0` artifact, and the Feature Pack Host/runtime.
