...
internal object SimplifiedChinesePreferencesStrings : PreferencesStrings {
    ...
    override fun message(id: PreferencesMessage, argument: String?, technicalDetail: String?): String {
        val summary = when (id) {
            ...
            PreferencesMessage.PUSH_TO_TALK_SHORTCUT_SAVED -> "按键说话快捷键已保存。"
            PreferencesMessage.PUSH_TO_TALK_SHORTCUT_CLEARED -> "按键说话快捷键已清除。"
            PreferencesMessage.PUSH_TO_TALK_SHORTCUT_SAVE_FAILED -> "无法保存按键说话快捷键。"
            PreferencesMessage.PUSH_TO_TALK_LISTENER_UNAVAILABLE -> "全局按键说话监听器不可用。"
