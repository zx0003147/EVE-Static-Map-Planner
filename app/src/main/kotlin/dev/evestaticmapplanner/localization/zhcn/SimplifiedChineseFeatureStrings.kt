...
internal object SimplifiedChineseAnsiblexStrings : AnsiblexStrings {
    ...
    override val identitySource = "来源"
    override val esiIdentity = "ESI 当前身份"
    override val manualIdentity = "手动模拟联盟"
    override val currentCharacter = "角色"
    override val currentAlliance = "Alliance"
    override val currentAllianceId = "手动联盟 ID"
    override val applyAllianceIdentity = "应用手动联盟"
    override val clearAllianceIdentity = "清除手动联盟"
    override val ownerAllianceId = "所属联盟 ID"
    override val ownerAllianceName = "所属联盟名称（可选）"
    override val ownerAllianceTicker = "所属联盟 ticker（可选）"
    ...
    override fun diagnostic(diagnostic: ImportDiagnostic): String {
        ...
        val message = when (diagnostic.code) {
            ...
            "INVALID_OWNER_ALLIANCE_NAME" -> "Owner Alliance 名称无效或过长。"
            "INVALID_OWNER_ALLIANCE_TICKER" -> "Owner Alliance ticker 无效或过长。"
            "BAD_CSV" -> "无法解析 CSV。"
    ...
    override fun accessStatus(status: AnsiblexAccessStatus) = when (status) {
        ...
        AnsiblexAccessStatus.ALLIANCE_NOT_SELECTED -> "Unknown · 当前 Alliance ID 缺失"
        AnsiblexAccessStatus.OWNER_UNKNOWN -> "Unknown · Owner Alliance ID 缺失"
        AnsiblexAccessStatus.ALLIANCE_MISMATCH -> "Denied · Alliance ID 不匹配"
    }
