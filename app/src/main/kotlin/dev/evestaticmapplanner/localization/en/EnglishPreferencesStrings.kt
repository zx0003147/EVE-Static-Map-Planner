...
internal object EnglishPreferencesStrings : PreferencesStrings {
    ...
    override fun message(id: PreferencesMessage, argument: String?, technicalDetail: String?): String {
        val summary = when (id) {
            ...
            PreferencesMessage.PUSH_TO_TALK_SHORTCUT_SAVED -> "Push-to-Talk shortcut saved."
            PreferencesMessage.PUSH_TO_TALK_SHORTCUT_CLEARED -> "Push-to-Talk shortcut cleared."
            PreferencesMessage.PUSH_TO_TALK_SHORTCUT_SAVE_FAILED -> "The Push-to-Talk shortcut could not be saved."
            PreferencesMessage.PUSH_TO_TALK_LISTENER_UNAVAILABLE -> "The global Push-to-Talk listener is unavailable."
